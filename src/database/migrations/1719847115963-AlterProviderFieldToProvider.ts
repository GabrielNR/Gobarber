...
export default class AlterProviderFieldToProvider1719847115963 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropForeignKey('appointments', 'AppointmentProvider'); //Deletar a foreignkey AppointmentProvider
